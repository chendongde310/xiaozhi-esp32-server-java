...
export default {
  ...
  template: {
    ...
    growth: {
      tabTemplate: '提示词模板',
      tabGrowth: '成长状态提示词',
      intro: '成长状态提示词会在每轮对话时，按当前状态（快乐能量 / 关系阶段 / 时间段 / 频道 / 首次见面 / 久别重逢 / 任务 / 档案）自动注入。可按角色差异化；未自定义的槽位使用系统默认。',
      selectRole: '选择角色',
      globalDefault: '全局默认（所有角色）',
      enabled: '启用',
      variables: '可用变量',
      save: '保存',
      reset: '重置为默认',
      resetConfirm: '确定重置为默认文案吗？当前自定义内容将被删除。',
      saveSuccess: '已保存',
      resetSuccess: '已重置为默认',
      loadFailed: '加载失败',
      emptyContent: '内容不能为空；如需关闭该槽位，请用启用开关',
      sourceRole: '角色自定义',
      sourceGlobal: '全局自定义',
      sourceDefault: '系统默认',
    },
  ...
  happyPlanet: {
    title: '快乐星球档案',
    subtitle: '来自快乐星球的陪伴智能体，与你相伴的记录与状态',
    selectAgent: '选择智能体',
    noAgents: '还没有智能体的陪伴记录，设备首次连接并对话后会自动建立。',
    stateTitle: '陪伴状态',
    energy: '快乐能量',
    energyLevel: { high: '充沛', mid: '平稳', low: '偏低' },
    companionDays: '陪伴天数',
    days: '天',
    currentChannel: '当前频道',
    todayTask: '今日星球任务',
    ...
    taskTodo: '未完成',
    profileTitle: '快乐星球档案',
    profileDesc: '在你授权下记住的偏好，可随时查看、修改、删除',
    field: '项目',
    value: '内容',
    empty: '暂无档案',
    addField: '新增档案项',
    ...
    inputValue: '请输入内容',
    clearAll: '清空档案',
    confirmDelete: '确定删除该档案项吗？',
    confirmClear: '确定清空该智能体的全部档案吗？此操作不可撤销。',
    growthTitle: '成长与徽章',
    stage: '羁绊阶段',
    stageNext: '距离「{name}」再近一点',
    streak: '连续打卡',
    bestStreak: '历史最长',
    repairCards: '补签卡',
    badges: '星球徽章',
