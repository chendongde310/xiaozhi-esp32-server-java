...
export default {
  ...
  template: {
    ...
    operationFailed: 'Operation failed',
    growth: {
      tabTemplate: 'Prompt Templates',
      tabGrowth: 'Growth-State Prompts',
      intro: 'Growth-state prompts are injected each turn based on the current state (happy energy / relationship stage / time of day / channel / first meeting / reunion / task / profile). They can be customized per role; slots without an override use the system default.',
      selectRole: 'Role',
      globalDefault: 'Global default (all roles)',
      enabled: 'Enabled',
      variables: 'Variables',
      save: 'Save',
      reset: 'Reset to default',
      resetConfirm: 'Reset to the default text? The current custom content will be removed.',
      saveSuccess: 'Saved',
      resetSuccess: 'Reset to default',
      loadFailed: 'Load failed',
      emptyContent: 'Content cannot be empty; use the Enabled switch to turn a slot off',
      sourceRole: 'Role override',
  ...
  router: {
    title: {
      ...
      happyPlanet: 'Happy Planet Profile',
      chat: 'Chat',
      account: 'Account',
      personalConfig: 'Settings',
      error403: '403 - Forbidden',
  ...
  happyPlanet: {
    title: 'Happy Planet Profile',
    subtitle: 'Companion records and status of your Happy Planet agent',
    selectAgent: 'Select agent',
    noAgents: 'No companion records yet. They are created after a device first connects and chats.',
    stateTitle: 'Companion Status',
    energy: 'Happy Energy',
    energyLevel: { high: 'Full', mid: 'Steady', low: 'Low' },
    companionDays: 'Companion Days',
    days: 'days',
    currentChannel: 'Current Channel',
    todayTask: "Today's Planet Task",
    taskNone: 'No planet task today',
    taskDone: 'Done',
    taskTodo: 'Not done',
    profileTitle: 'Happy Planet Profile',
    profileDesc: 'Preferences remembered with your consent — view, edit, or delete anytime',
    field: 'Item',
    value: 'Value',
    empty: 'No profile entries',
    addField: 'Add entry',
    editField: 'Edit entry',
    selectField: 'Select an item',
    inputValue: 'Enter a value',
    clearAll: 'Clear all',
    confirmDelete: 'Delete this profile entry?',
    confirmClear: 'Clear ALL profile entries for this agent? This cannot be undone.',
    fields: {
      nickname: 'Nickname',
      preferredCall: 'Preferred name',
      storyType: 'Favorite story type',
      storyLength: 'Story length',
      companionStyle: 'Companion style',
      activeTime: 'Usual time',
